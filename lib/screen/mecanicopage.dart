...
class MecanicoPage extends StatefulWidget {
  const MecanicoPage({Key? key}) : super(key: key);
...
class _MecanicoPageState extends State<MecanicoPage> {
  List<LocationInfo> locations = [
    ...
    LocationInfo('Zapopan', 'Mecanicos en Zapopan', [
      GruainformacionDelServicio('Gruas24x7', '332238512'),
    ]),
    LocationInfo('Tlaquepaque', 'Mecanicos en Tlaquepaque', [
      GruainformacionDelServicio('GrúasExpress', '3322385127'),
    ]),
    LocationInfo('Guadalajara', 'Mecanicos en Guadalajara', [
      GruainformacionDelServicio('MyGrua', '3338200171'),
    ]),
    LocationInfo('Tonala', 'Mecanicos en Tonala', [
  ...
  Widget _buildDirectory() {
    return Container(
      ...
      child: Column(
        children: [
          const SizedBox(height: 20),
          const Text('Directorio de Mecanico', style: TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 10),
          ListView(
            shrinkWrap: true,
